...
const UserProfile = () => {
  ...
  const loadUserListings = async () => {
    ...
    try {
      ...
      const totalFavorites = listingsWithFavorites.reduce(
        (sum, listing) => sum + listing.favoriteCount,
        0
      );
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl font-bold mb-6">{t("personal.cabinet")}</h1>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardFooter>
                  ...
                  >
                    {isEditingProfile ? t("cancel") : t("edit.profile")}
                  </Button>
                </CardFooter>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>{t("listings.statistics")}</CardTitle>
                </CardHeader>
                <CardContent>
